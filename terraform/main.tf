...
resource "aws_security_group" "bastion" {
  name        = "bastion-ec2-sg"
  description = "Bastion EC2 Host Security Group"
  vpc_id      = aws_vpc.main.id
  ...
  ingress {
    ...
    to_port     = 22
    protocol    = "tcp"
    cidr_blocks = ["102.89.41.102/32"] # Replace <YOUR_IP> with your public IP address
  }
...
data "aws_ssm_parameter" "my_private_key" {
  name            = "/ec2/key-pair/my-key-pair"
